// Generated by @wagmi/cli@0.1.15 on 4/30/2023 at 2:12:33 AM
import {
  getContract,
  GetContractArgs,
  readContract,
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link snewsABI}__.
 */
export function getSnews(config: Omit<GetContractArgs, 'abi'>) {
  return getContract({ abi: snewsABI, ...config })
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link snewsABI}__.
 */
export function readSnews<
  TAbi extends readonly unknown[] = typeof snewsABI,
  TFunctionName extends string = string,
>(config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi'>) {
  return readContract({
    abi: snewsABI,
...
/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link snewsABI}__.
 */
export function writeSnews<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof snewsABI, TFunctionName>, 'abi'>
    | Omit<WriteContractUnpreparedArgs<typeof snewsABI, TFunctionName>, 'abi'>,
) {
  return writeContract({ abi: snewsABI, ...config } as WriteContractArgs<
    typeof snewsABI,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link snewsABI}__.
 */
export function prepareWriteSnews<
  TAbi extends readonly unknown[] = typeof snewsABI,
  TFunctionName extends string = string,
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, 'abi'>) {
  return prepareWriteContract({
...
/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link snewsABI}__.
 */
export function watchSnewsEvent<
  TAbi extends readonly unknown[] = typeof snewsABI,
  TEventName extends string = string,
>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, 'abi'>,
  ...
  return watchContractEvent(
    { abi: snewsABI, ...config } as WatchContractEventConfig<TAbi, TEventName>,
    callback,
  )
}
