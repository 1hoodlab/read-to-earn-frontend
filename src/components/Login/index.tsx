        ...
        <>
            ...
            <Box position={"fixed"} inset={0} background={"rgba(24, 21, 21, 0.82)"} zIndex={10} >
                <Box width={608} height={570} background={"#FFFFFD"} marginTop={70}
                    ...
                    <Text fontWeight={500} fontSize={"12px"} lineHeight={"14.52px"} color={"#666666"} marginTop={0.8}>
                        Continue with Google or enter your details.
                    </Text>
                    <Flex border={"2px solid #000000"}
                        borderRadius={6}
                        width={352}
                        marginLeft={"auto"}
                        marginRight={"auto"}
                    ...
                    <Box marginTop={10}>
                        ...
                        <Box height={0.5} background={"#DFDFDF"} width={"full"} marginTop={1} ></Box>
                        <Text textAlign={"right"} fontWeight={600} fontSize={"14px"} lineHeight={"16.94px"} marginTop={1.5}>Forgot password?</Text>
                    </Box>
                    ...
                    <Flex justifyContent={"center"} marginTop={3}>
                        ...
                        <Text fontWeight={600} fontSize={"14px"} lineHeight={"16.94px"} marginLeft={1.5}> Sign up for free </Text>
                    </Flex>
                </Box>
            </Box >
        </>
